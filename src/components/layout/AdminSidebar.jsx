    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem', padding: '0 0.5rem' }}>
        ...
        <div>
          ...
          <span style={{ fontSize: '0.7rem', color: '#A78BFA', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase' }}>
            Control Center
          </span>
        </div>
      </div>
          ...
          return (
            <NavLink
              ...
              style={({ isActive }) => ({
                ...
                fontWeight: 600,
                textDecoration: 'none',
                boxShadow: isActive ? '0 0 15px rgba(167, 139, 250, 0.12)' : 'none',
      ...
      <div style={{ marginTop: 'auto', paddingTop: '1rem', borderTop: '1px solid rgba(255, 255, 255, 0.08)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.75rem', backgroundColor: '#111827', borderRadius: '10px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', overflow: 'hidden' }}>
            <div style={{ width: '32px', height: '32px', borderRadius: '50%', backgroundColor: 'rgba(167, 139, 250, 0.2)', color: '#A78BFA', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.8rem', fontWeight: 700, flexShrink: 0 }}>
              A
            </div>
            <div style={{ overflow: 'hidden' }}>
              ...
              <p style={{ fontSize: '0.7rem', color: '#64748B', margin: 0 }}>Master Access</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            title="Admin Logout"
            style={{ background: 'transparent', border: 'none', color: '#F87171', cursor: 'pointer', padding: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
          >
            <LogOut size={16} />
          </button>
        </div>
